    ...
    <div class="bg-body-secondary">
            ...
            <div class="container">
                <div class="row">
                    <nav aria-label="breadcrumb" style="direction: rtl">
                        <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{ route('guest.articles.index') }}">{{ __('guest/cms/blog/article.extra.home') }}</a></li>
        ...
        @auth
            <section id="sec-8" class="my-4">
                <div class="container">
                    <h5 class="text-end"> {{ __('guest/cms/blog/article.extra.comment') }}</h5>
                    ...
                    <form class="bg-white py-3 px" action="{{ Route('guest.articles.comments') }}" method="post">
                        ...
                        <div class="comment row m-4">
                            ...
                            <div class="comm-area col-lg-12 col-md-12">
                                <label class="area-content" for="area">{{ __('guest/cms/blog/article.fields.comment') }} </label><br>
                            ...
                            <div>
                                <button class="btn btn-primary" type="submit">{{ __('guest/cms/blog/article.buttons.send') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
