...
@section('title')
{{__('guest/cms/faq/faq.pages.index')}}
@endsection
@section('content')
    <!-- Start Section-1 -->
    <div class="container">
        <h6 class="text-end mb-2 text-black-50">{{__('guest/cms/faq/faq.extra.home')}}</h6>
        <h4 class="text-end mb-5">{{__('guest/cms/faq/faq.pages.index')}}</h4>
    </div>
