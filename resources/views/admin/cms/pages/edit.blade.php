...
@section('title')
{{ __('admin/CMS/page/page.pages.edit') }} 
@endsection
            ...
            <form action="{{ Route('admin.pages.update', $page->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row col-12">
                    ...
                    <div class="form-group col-12">
                        <label>{{ __('admin/CMS/page/page.fields.title') }}</label>
                    ...
                    <div class="form-group col-12">
                        <label>{{ __('admin/CMS/page/page.fields.content') }}</label>
                    ...
                    <div class="custom-control custom-switch mx-3 mt-2 col-12">
                        ...
                        <label class="custom-control-label" for="is_active">{{ __('admin/CMS/page/page.extra.open') }}</label>
                    </div>

                    <div class="custom-control custom-switch mx-3 mt-2 col-12">
                        <input @checked($page->is_in_footer) type="checkbox" class="custom-control-input" id="is_in_footer" name="is_in_footer">
                        <label class="custom-control-label" for="is_in_footer">{{ __('admin/CMS/page/page.fields.is_in_footer') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-switch mx-3 my-2 col-12">
                        ...
                        <label class="custom-control-label" for="is_in_menu">{{ __('admin/CMS/page/page.fields.is_in_menu') }}</label>
                    </div>

                    <div class="form-group col-md-12">
                        <button type="submit" class="btn btn-sm btn-primary">
                            {{ __('admin/CMS/page/page.buttons.edit') }}</button>
                    </div>
