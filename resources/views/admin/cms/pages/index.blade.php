...
<div class="card shadow-sm">
    ...
    <div class="card-body table-responsive">
        ...
        <table class="table table-striped text-center" id="pages">
            <thead>
                <tr>
                    <th>{{ __('admin/CMS/page/page.fields.title') }}</th>
                    <th>{{ __('admin/CMS/page/page.fields.is_active') }}</th>
                    <th>{{ __('admin/CMS/page/page.extra.actions') }}</th>
                </tr>
            </thead>
            <tbody>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <p class="modal-title">{{ __('admin/CMS/page/page.extra.confirm_delete') }}</p>
                                        ...
                                        <div class="modal-body text-left">
                                            <p>{{ __('admin/CMS/page/page.extra.Are you sure you want delete this item') }}</p>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-md"
                                                data-dismiss="modal">{{ __('admin/CMS/page/page.extra.close') }}</button>
                                            <form action="{{ route('admin.pages.destroy', $page->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-dark btn-md">{{ __('admin/CMS/page/page.extra.yes') }}</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
