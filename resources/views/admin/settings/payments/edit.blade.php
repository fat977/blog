...
@section('title')
    {{ __('admin/setting/payment/payment.pages.edit') }}
@endsection
        ...
        <div class="card-body">
            ...
            <form action="{{ Route('admin.payments.update', $payment->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row col-12">
                    ...
                    <div class="form-group col-12">
                        <label for="logo" class="mb-3">{{ __('admin/setting/payment/payment.fields.logo') }}</label>
                    ...
                    <div class="form-group col-md-12">
                        <button type="submit" class="btn btn-sm btn-primary">
                            {{ __('admin/setting/payment/payment.buttons.edit') }}</button>
                    </div>
                </div>
            </form>
        </div>
