                        ...
                        <tr>
                            ...
                            <td>
                                @if (!request()->has('trashed'))
                                    ...
                                    <div class="modal fade" id="confirm-delete-activity">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <form action="{{ route('admin.users.deleteActivities', $user->id) }}"
                                                        method="POST">
                                                        @csrf
                                ...
                                @else
                                    ...
                                    <div class="modal fade" id="confirm-delete-activitiees">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <p class="modal-title">{{ __('admin/users/user.extra.confirm_delete') }} </p>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#confirm-deleted-{{ $user->id }}">
                                        <i class="fas fa-trash p-2"></i>
                                    </button>
                                    <div class="modal fade" id="confirm-deleted-{{ $user->id }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <p class="modal-title">تأكيد الحذف</p>
