...
@section('title')
{{ __('auth/reset_password.pages.index') }}
@endsection
@section('content')
    <div class="container">
                                ...
                                <div class="card text-dark" style="background-color:#ECEFF4 ; border-radius: 1rem;">
                                    <div class="card-body p-5 text-center">
                                        <div class="mb-md-2 mt-md-4 py-3">
                                            ...
                                            <h2 class="fw-bold mb-2 text-uppercase">{{ __('auth/reset_password.pages.index') }}</h2>

                                            <input type="hidden" name="token" value="{{ $token }}">

                                            <div class="form-outline form-dark my-2">
                                                <input type="email" class="form-control py-2" name="email"
                                                    value="{{ $email ?? old('email') }}" placeholder="{{ __('auth/reset_password.extra.email') }}"
                                            ...
                                            <div class="form-outline form-dark mb-2">
                                                <input type="password" class="form-control py-2" name="password"
                                                    placeholder="{{ __('auth/reset_password.extra.password') }}" autocomplete="new-password" />
                                            ...
                                            <div class="form-outline form-dark mb-2">
                                                <input type="password" class="form-control py-2"
                                                    name="password_confirmation" placeholder="{{ __('auth/reset_password.extra.password_confirmation') }}" />
                                            ...
                                            <button class="btn btn-dark btn-lg px-5" type="submit"> {{ __('auth/reset_password.buttons.reset') }}
                                                </button>
