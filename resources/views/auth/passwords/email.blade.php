...
@section('content')
@section('title')
{{ __('auth/forgot_password.pages.index') }} 
@endsection
<div class="container">
                            ...
                            <div class="card text-dark" style="background-color:#ECEFF4 ; border-radius: 1rem;">
                                <div class="card-body p-5 text-center">
                                    <div class="mb-md-2 mt-md-4 pb-4">
                                        <h2 class="fw-bold mb-2 text-uppercase">{{ __('auth/forgot_password.extra.header') }}  </h2>
                                        <div class="form-outline form-dark my-4">
                                            <input type="email" class="form-control py-2" name="email"
                                                value="{{ old('email') }}" placeholder="{{ __('auth/forgot_password.extra.email') }} " />
                                        ...
                                        <button class="btn btn-dark col-12 md-4" type="submit">{{ __('auth/forgot_password.buttons.send') }}   
                                            </button>
                                    </div>
                                </div>
                            </div>
