...
class FaqCategory extends Controller
{
    ...
    public function store(FaqCategoryRequest $request)
    {
        ...
        return redirect()
            ...
            ->with('success', __('admin/CMS/faq/category/faq_category.messages.create'));
    }
    ...
    public function update(FaqCategoryRequest $request,$id)
    {
        ...
        return redirect()
            ->route('admin.faqs-categories.index')
            ->with('success', __('admin/CMS/faq/category/faq_category.messages.edit'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with(['success' => __('admin/CMS/faq/category/faq_category.messages.delete')]);
    }
}
