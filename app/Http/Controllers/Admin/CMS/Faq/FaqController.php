...
class FaqController extends Controller
{
    ...
    public function store(FaqValidation $request)
    {
        ...
        return redirect()->route('admin.faqs.index')->with('success',  __('admin/CMS/faq/faq.messages.create'));
    }
    ...
    public function update(FaqValidation $request, $id)
    {
        ...
        return redirect()->route('admin.faqs.index')->with('success',  __('admin/CMS/faq/faq.messages.edit'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with(['success' => __('admin/CMS/faq/faq.messages.delete')]);
    }
}
