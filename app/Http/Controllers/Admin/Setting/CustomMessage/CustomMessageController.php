...
class CustomMessageController extends Controller
{
    ...
    public function store(StoreCustomMessageRequest $request)
    {
        ...
        return redirect()->route('admin.custom-message.index')->with('success', __('admin/setting/custom_message/custom_message.messages.create'));
    }
    ...
    public function update(UpdateCustomMessageRequest $request, int $id)
    {
        ...
        return redirect()->route('admin.custom-message.index')->with('success', __('admin/setting/custom_message/custom_message.messages.edit'));
    }
    ...
    public function destroy(int $id)
    {
        ...
        return redirect()->back()->with('success', __('admin/setting/custom_message/custom_message.messages.delete'));
    }
    ...
    public function changeActive(ChangeActiveCustomMessageRequest $request, CustomMessage $msg)
    {
        ...
        return redirect()->back()
            ->with('success', __('admin/setting/custom_message/custom_message.messages.edit_active'));
